...
/**
 * @author zhangpei
 * @date on 17-8-23 上午10:26
 * @package com.new_jew.main.ui.activity
 * 从车库到展厅
 */

public class GarageInToExhibitionActivity extends BaseActivity implements GetCarLib, Popinterface, CheckCarible {
...
//    TextView carTest;
    ...
    private boolean isfirst;//是否是第一个照相列表
    private ArrayList<String> car_id_list;//车库地址ID
...
//        }
    ...
    protected int setRootView() {
        return R.layout.layout_g_into_e;
    }
...
//                surePutCarPst.UpDataPic(file_root, index, dialog);
                ...
                if (file_root.exists()) {
                    showPopView.close();
//                    bitmap = BitmapCompressUtils.imageZoom(file_root.getAbsolutePath(), 300);
//
...
//                        dialog.dismiss();
//
//                        CameraTool.setPicToView(bitmap, "sellCar2.jpg", paths);
//                        File file1 = new File(paths + "sellCar2.jpg");
        ...
        HttpUtils.Gethttp(params, new IOCallback() {
            ...
            public void onSuccess(Object result) throws UnsupportedEncodingException {
                ...
                try {
                    ...
                    carAddress.setText(car_lib_list.get(0));
