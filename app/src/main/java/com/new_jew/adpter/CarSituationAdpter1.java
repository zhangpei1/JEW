 ...
 */
public class CarSituationAdpter1 extends BaseAdapter {
    private ArrayList<ScreenBean> mlist;
    private boolean ischeck = false;
    private int clickStatus = -2;
    private List<HandoverEvidenceBean> list;

    public CarSituationAdpter1(ArrayList<ScreenBean> mlist, Context context) {
        this.mlist = mlist;
...
//                hodler.mtext.toggle();
                ...
                Log.e("===", String.valueOf(hodler.mtext.isChecked()));
            }

        } else {
            if (mlist.get(position).ishave() == true) {
                hodler.mtext.setChecked(true);
                Log.e("position",String.valueOf(position));
            } else {
                hodler.mtext.setChecked(false);
                Log.e("position_dalse",String.valueOf(position));
            }
        }
