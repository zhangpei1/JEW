...
public class CollectionFragment extends BaseFragment {
    ...
    protected void initLayout() {
        collection_listview = (PullToRefreshListView) view.findViewById(R.id.collection_listview);
        imageView = (LinearLayout) view.findViewById(R.id.image);
    }

    @Override
    protected void initValue() {
        collection_listview.setMode(PullToRefreshBase.Mode.BOTH);
    ...
    protected void initListener() {
        collection_listview.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            @Override
